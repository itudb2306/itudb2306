class UpdateForm:
    ...
    def from_dict(self, dict):
        ...
        self.FirstName = dict.get('FirstName', None)
        self.LastName = dict.get('LastName', None)
        self.TeamName = dict.get('TeamName', None)
        self.yearID = dict.get('yearID', None)
        self.stint = dict.get('stint', None)
        self.LeagueName = dict.get('LeagueName', None)
        self.POS = dict.get('POS', None)
        self.G = dict.get('G', None)
        self.GS = dict.get('GS', None)
        self.InnOuts = dict.get('InnOuts', None)
        self.PO = dict.get('PO', None)
        self.A = dict.get('A', None)
